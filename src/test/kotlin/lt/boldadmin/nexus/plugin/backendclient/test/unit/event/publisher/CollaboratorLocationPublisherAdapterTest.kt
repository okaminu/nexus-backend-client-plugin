package lt.boldadmin.nexus.plugin.backendclient.test.unit.event.publisher

import io.mockk.*
import io.mockk.impl.annotations.MockK
import lt.boldadmin.nexus.api.type.valueobject.Coordinates
import lt.boldadmin.nexus.api.type.valueobject.Message
import lt.boldadmin.nexus.plugin.backendclient.event.publisher.CollaboratorLocationPublisherAdapter
...
class CollaboratorLocationPublisherAdapterTest {
    ...
    fun `Updates collaborator location by message`() {
        ...
        every { propertiesFactory.create(MessageSerializer::class.java) } returns properties
        every { producerSpy.send(any()) } returns mockk()
